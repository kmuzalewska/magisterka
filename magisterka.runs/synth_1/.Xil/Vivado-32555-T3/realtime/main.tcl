...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "./.Xil/Vivado-32555-T3/realtime/tmp"
    ...
    set rt::partid xczu17eg-ffvc1760-2-e
    ...
    if {$rt::useElabCache == false} {
      rt::read_verilog -sv -include /home/klara/magisterka/generation_MEM_files /home/user/Xilinx/Vivado/2018.3/data/ip/xpm/xpm_memory/hdl/xpm_memory.sv
      rt::read_vhdl -lib xpm /home/user/Xilinx/Vivado/2018.3/data/ip/xpm/xpm_VCOMP.vhd
...
# MODE: 
    ...
    rt::set_parameter enableSplitFlowPath "./.Xil/Vivado-32555-T3/"
